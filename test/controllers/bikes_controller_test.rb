...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference("Bike.count") do
      post bikes_url, params: { bike: { desc: @bike.desc, name: @bike.name, price: @bike.price, style: @bike.style } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { desc: @bike.desc, name: @bike.name, price: @bike.price, style: @bike.style } }
